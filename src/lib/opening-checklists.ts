...
export const defaultOpeningSetupItems: OpeningChecklistSeedItem[] = [
  ...
  setup("Altyapı", "Su tesisatı", "INVESTOR", 20),
  setup("Altyapı", "Su arıtma hazırlığı", "INVESTOR", 30),
  ...
  setup("Mimari ve İnşaat", "Taş duvar", "INVESTOR", 100),
  setup("Mimari ve İnşaat", "Demir işleri", "INVESTOR", 110),
  setup("Mimari ve İnşaat", "Lavabo / WC", "INVESTOR", 120),
  setup("Mimari ve İnşaat", "Badana", "INVESTOR", 130),
  setup("Mimari ve İnşaat", "Alçıpan", "INVESTOR", 140),
  setup("Mimari ve İnşaat", "Giriş düzenlemesi", "INVESTOR", 150),
  ...
  setup("Mobilya ve Dekor", "Mutfak mobilyaları", "PURCHASING", 240),
  setup("Mobilya ve Dekor", "Oturma grupları", "PURCHASING", 250),
  setup("Mobilya ve Dekor", "Dekor", "ARCHITECTURE", 260),
  setup("Mobilya ve Dekor", "Peyzaj", "ARCHITECTURE", 270),
