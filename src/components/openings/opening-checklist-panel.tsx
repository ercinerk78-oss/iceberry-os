...
export function OpeningChecklistPanel({
  ...
  const activeSetupItems = setupItems.filter((item) => !item.archivedAt && !isSupplyChecklistCategory(item.category));
