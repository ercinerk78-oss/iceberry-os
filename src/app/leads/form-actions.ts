...
export async function changeLeadCategoryForm(leadId:string,_:LeadActionState,formData:FormData):Promise<LeadActionState>{return changeLeadCategory(leadId,String(formData.get("leadCategory")))}
